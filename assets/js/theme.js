    ...
    $(function () {
        $("#range-slider").slider({
            ...
            slide: function (event, ui) {
                $(".price-amount-from").text(ui.values[0] + " ans");
                $(".price-amount-to").text(ui.values[1] + " ans");
                $('#minage').val($("#range-slider").slider("values", 0));
                $('#maxage').val($("#range-slider").slider("values", 1));


            }
        });

        $(".price-amount-from").text($("#range-slider").slider("values", 0) + " ans");
        $(".price-amount-to").text($("#range-slider").slider("values", 1) + " ans");
    });
};
